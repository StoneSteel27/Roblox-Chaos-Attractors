-- The following code is very similar to Aizawa Attractor, but the parameters of the Attractor are changed to achieve this Toroid shaped Attractor
...
local function getToroidPos(part)

	local a = 0.95
	local b = 0.7
	local c = 1.0
	local d = 0.7 -- This is the updated parameter
	local e = 0.25
	local f = 0.1
